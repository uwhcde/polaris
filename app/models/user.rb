class User < ActiveRecord::Base
  ...
  has_attached_file :cover_image, styles: { medium: "400x150", large: "800x300" }, :default_url => ":style/missing.jpg"
  has_attached_file :picture, styles: { small: "64x64", medium: "100x100", large: "200x200" }, :default_url => ":style/missing.jpg"
